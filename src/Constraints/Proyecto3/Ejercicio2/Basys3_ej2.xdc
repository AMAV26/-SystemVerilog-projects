...
#create_generated_clock -name from_pll -source [get_ports clk] -divide_by 10 [get_pins U1/clk_out1]

#set_output_delay -clock [get_clocks from_pll] 2 [get_ports -filter { NAME =~  '*' && DIRECTION == 'OUT' }]	